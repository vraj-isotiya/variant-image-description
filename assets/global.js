...
class VariantSelects extends HTMLElement {
  ...
  connectedCallback() {
    this.addEventListener("change", (event) => {
      ...
      this.filterImageVariant(target);
  ...
  //get the current product varient image
  filterImageVariant(target) {
